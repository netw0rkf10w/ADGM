function [X] = ADGM1(X0, indH1, valH1, indH2, valH2, indH3, valH3, rho, MAX_ITER, verb, eta, iter1, iter2)
% input:
...
%  X2 / N2 x N1 matrix / output assignment matrix
    ...
    [x, ~, ~] = mexADGM_3rdORDER(X0, int32(indH1), -valH1, int32(indH2), -valH2, int32(indH3), -valH3, rhos, MAX_ITER, verb, false, iter1, iter2, 1);
    [N2,N1] = size(X0);
    X = reshape(x, N2, N1);
end
